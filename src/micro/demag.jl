...
function init_demag(sim::MicroSim, Nx::Int, Ny::Int, Nz::Int; pbc1d_axis::Int=0, pbc2d_pair::Int=0)
    mesh = sim.mesh
    ...
    pbc2d_pair != 0 && pbc2d_add_tail!(tensor, pbc2d_pair, 1, Nx, Ny, Nz, dx, dy, dz, nx, ny, nz)
    pbc2d_pair != 0 && pbc2d_dc_fix!(tensor, pbc2d_pair, 1, nx, ny, nz)
    ...
    pbc2d_pair != 0 && pbc2d_add_tail!(tensor, pbc2d_pair, 2, Nx, Ny, Nz, dx, dy, dz, nx, ny, nz)
    pbc2d_pair != 0 && pbc2d_dc_fix!(tensor, pbc2d_pair, 2, nx, ny, nz)
    fill_tensors(mx_pad, tensor, false, false, false)
    ...
    pbc2d_pair != 0 && pbc2d_add_tail!(tensor, pbc2d_pair, 3, Nx, Ny, Nz, dx, dy, dz, nx, ny, nz)
    pbc2d_pair != 0 && pbc2d_dc_fix!(tensor, pbc2d_pair, 3, nx, ny, nz)
    fill_tensors(mx_pad, tensor, false, false, false)
    ...
    pbc2d_pair != 0 && pbc2d_add_tail!(tensor, pbc2d_pair, 4, Nx, Ny, Nz, dx, dy, dz, nx, ny, nz)
    pbc2d_pair != 0 && pbc2d_dc_fix!(tensor, pbc2d_pair, 4, nx, ny, nz)
    ...
    pbc2d_pair != 0 && pbc2d_add_tail!(tensor, pbc2d_pair, 5, Nx, Ny, Nz, dx, dy, dz, nx, ny, nz)
    pbc2d_pair != 0 && pbc2d_dc_fix!(tensor, pbc2d_pair, 5, nx, ny, nz)
    ...
    pbc2d_pair != 0 && pbc2d_add_tail!(tensor, pbc2d_pair, 6, Nx, Ny, Nz, dx, dy, dz, nx, ny, nz)
    pbc2d_pair != 0 && pbc2d_dc_fix!(tensor, pbc2d_pair, 6, nx, ny, nz)
