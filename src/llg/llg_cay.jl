...
function llg_cay_call_back(sim::AbstractSim, dw_dt::Array{Float64, 1}, t::Float64, omega::Array{Float64, 1})
  ...
  llg_rhs_Cay(dw_dt, sim.spin, sim.field, omega, sim.pins, sim.driver.alpha, sim.driver.gamma, sim.driver.precession, sim.n_total)
...
function llg_stt_cay_call_back(sim::AbstractSim, dw_dt::Array{Float64, 1}, t::Float64, omega::Array{Float64, 1})
  ...
  compute_field_stt(sim.spin, driver.h_stt, driver.ux, driver.uy, driver.uz, mesh.dx, mesh.dy, mesh.dz, mesh.ngbs, sim.n_total)

  llg_stt_rhs_Cay(dw_dt, sim.spin, sim.field, driver.h_stt, omega, sim.pins, driver.alpha, driver.beta, driver.gamma, sim.n_total)
