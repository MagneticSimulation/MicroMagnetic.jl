...
include("micro/stencil.jl")
include("micro/kernels.jl")
include("micro/field.jl")
include("micro/demag.jl")
include("micro/demag_direct.jl")
include("micro/demag_pbc3d.jl")
include("micro/demag_pbc2d.jl")
include("micro/demag_pbc1d.jl")
include("micro/demagc.jl")
...
include("integrator/adaptive_rk.jl")
include("integrator/adaptive_rk_steps.jl")
include("integrator/dopri5_cayley.jl")
include("integrator/gpsm.jl")
include("fileio.jl")
include("sim.jl")
include("sim_with.jl")
include("init_m.jl")
