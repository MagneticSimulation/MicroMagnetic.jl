...
function apply_field1(mesh)
  sim = Sim(mesh, name="std4_dyn_H", integrator="RungeKutta")
  set_Ms(sim, 8.0e5)
  sim.driver.alpha = 0.02
  sim.driver.gamma = 2.211e5
  sim.driver.precession = true
  sim.driver.ode.step = 1e-13
  ...
  relax(sim, maxsteps=10000, stopping_dmdt = 0.1, save_m_every=100)
  #for i=1:100
