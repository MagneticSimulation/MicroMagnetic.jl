...
const vortex = [
    { title: "Create Mesh", code: `mesh = FDMesh(nx=100, ny=100, nz=10, dx=2e-9, dy=2e-9, dz=2e-9);`, cellType: "mesh" },
    { title: "Create Simulation", code: `sim = Sim(mesh; name="vortex", driver="SD")`, cellType: "sim" },
    { title: "Set Saturation Magnetization", code: `set_Ms(sim, Cylinder(radius = 100e-9), 8e5)`, cellType: "ms" },
    { title: "Initialize Magnetization", code: `init_m0(sim, vortex(p=1, c=-1))`, cellType: "m0" },
...
const std4 = [
    ...
    { title: "Create Simulation", code: `sim = Sim(mesh; name="std4", driver="SD")`, cellType: "sim" },
    { title: "Set Saturation Magnetization", code: `set_Ms(sim, 8e5)`, cellType: "ms" },
